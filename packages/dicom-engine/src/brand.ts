...
export type SegmentationId = Brand<string, "SegmentationId">;
...
export function SegmentationId(value: string): SegmentationId {
  return value as SegmentationId;
}

export function VolumeId(value: string): VolumeId {
